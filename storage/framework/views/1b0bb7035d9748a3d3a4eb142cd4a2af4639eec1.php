	...
	<div class="col-sm-offset-4 col-sm-4">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="col-sm-12">
					<?php echo Form::open(['route' => 'collaborateur.store', 'class' => 'form-horizontal panel']); ?>
          ...
          <!-- <div class="form-group"> -->
					...
					<div class="form-group  <?php echo $errors->has('Responsable_TCa') ? 'has-error' : ''; ?>">
					  	<!-- <?php echo Form::select('Responsable_TCa',['Cédric Dupuis', 'Bastien Jambon'], null, ['class' => 'form-control', 'placeholder' => 'Responsable']); ?> -->
